...
Usage:
    from ultralytics_v10.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_v10.cfg import TASK2DATA, TASK2METRIC
from ultralytics_v10.engine.exporter import export_formats
from ultralytics_v10.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_v10.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics_v10.utils.files import file_size
from ultralytics_v10.utils.torch_utils import select_device
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics_v10.utils.benchmarks import ProfileModels
