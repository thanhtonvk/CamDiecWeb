...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.checks import parse_requirements
...
def check_font(font="Arial.ttf"):
    ...
    url = f"https://ultralytics_v10.com/assets/{name}"
...
def collect_system_info():
    ...
    from ultralytics_v10.utils import ENVIRONMENT, is_git_dir
    from ultralytics_v10.utils.torch_utils import get_cpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from ultralytics_v10.utils.checks import check_amp
