...
from ultralytics_v10.utils import LOGGER, TryExcept, ops, plt_settings, threaded
...
class Colors:
    """
    Ultralytics default color palette https://ultralytics_v10.com/.
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.plotting import save_one_box
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.plotting import plot_results
