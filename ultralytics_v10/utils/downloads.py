...
from ultralytics_v10.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.downloads import unzip_file
...
def check_disk_space(url="https://ultralytics_v10.com/assets/coco128.zip", path=Path.cwd(), sf=1.5, hard=True):
    """
    Check if there is sufficient disk space to download and store a file.

    Args:
        url (str, optional): The URL to the file. Defaults to 'https://ultralytics_v10.com/assets/coco128.zip'.
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from ultralytics_v10.utils.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Example:
        ```python
        from ultralytics_v10.utils.downloads import safe_download

        link = "https://ultralytics_v10.com/assets/bus.jpg"
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.1.0", **kwargs):
    ...
    Example:
        ...
        ```
    """
    from ultralytics_v10.utils import SETTINGS  # scoped for circular import
...
def download(url, dir=Path.cwd(), unzip=True, delete=False, curl=False, threads=1, retry=3, exist_ok=False):
    ...
    Example:
        ```python
        download('https://ultralytics_v10.com/assets/example.zip', dir='path/to/dir', unzip=True)
        ```
    """
    dir = Path(dir)
