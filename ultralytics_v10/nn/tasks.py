...
from ultralytics_v10.nn.modules import (
    AIFI,
    C1,
    C2,
    C3,
...
from ultralytics_v10.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics_v10.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics_v10.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8OBBLoss, v8PoseLoss, v8SegmentationLoss, v10DetectLoss
from ultralytics_v10.utils.plotting import feature_visualization
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics_v10.models.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight):
    ...
    """
    from ultralytics_v10.utils.downloads import attempt_download_asset
    ...
    try:
        with temporary_modules(
            {
                "ultralytics_v10.yolo.utils": "ultralytics_v10.utils",
                "ultralytics_v10.yolo.v8": "ultralytics_v10.models.yolo",
                "ultralytics_v10.yolo.data": "ultralytics_v10.data",
            }
        ...
        if e.name == "models":
            raise TypeError(
                emojis(
                    ...
                    f"YOLOv8 at https://github.com/ultralytics/ultralytics_v10."
