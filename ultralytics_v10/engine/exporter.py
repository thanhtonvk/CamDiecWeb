...
from ultralytics_v10.cfg import get_cfg
from ultralytics_v10.data.dataset import YOLODataset
from ultralytics_v10.data.utils import check_det_dataset
from ultralytics_v10.nn.autobackend import check_class_names, default_class_names
from ultralytics_v10.nn.modules import C2f, Detect, RTDETRDecoder, v10Detect
from ultralytics_v10.nn.tasks import DetectionModel, SegmentationModel, WorldModel
from ultralytics_v10.utils import (
    ARM64,
    DEFAULT_CFG,
    LINUX,
    LOGGER,
...
from ultralytics_v10.utils.checks import PYTHON_VERSION, check_imgsz, check_is_path_safe, check_requirements, check_version
from ultralytics_v10.utils.downloads import attempt_download_asset, get_github_assets
from ultralytics_v10.utils.files import file_size, spaces_in_path
from ultralytics_v10.utils.ops import Profile
from ultralytics_v10.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode
    ...
    def __call__(self, model=None):
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.ultralytics_v10.com/models/yolo-world for details."
            )
